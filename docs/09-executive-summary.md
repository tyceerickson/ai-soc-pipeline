...
* **Signature:** an SSH public key ending in `mdrfckr` implanted via `\~/.ssh/authorized\_keys`
...
|LLM inference (Ollama + qwen2.5:7b-instruct)|Alienware m16 R2 (RTX 4070)|AI threat analysis|
...
Tailscale, rsync, MaxMind GeoLite2, VirusTotal API, Ollama, qwen2.5:7b-instruct, HTML5 Canvas,
